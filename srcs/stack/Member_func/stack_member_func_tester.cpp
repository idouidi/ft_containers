...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   stack_member_func_tester.cpp                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: idouidi <idouidi@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/25 15:09:29 by idouidi           #+#    #+#             */
/*   Updated: 2023/01/25 16:39:54 by idouidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void stack_member_func_tester()
{
    ...
    /* CONSTRCUTOR */
    {
		...
		/* 📌 EMPTY */ NAMESPACE::stack<int> stk;
		printContent(filename.c_str(), "EMPTY CONSTRCUCTOR", stk);		

        /* 📌 FILL */ NAMESPACE::stack<int> fill_stk(3, 42);
		printContent(filename.c_str(), "FILL CONSTRCUCTOR", stk);		
